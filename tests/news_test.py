...
class TestArticles(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_article = Articles(1,'najma','Kenyan Man breaks world record','Kipchoge breaks the world record on 2 hour marathon','https://techtoday.com','https://marathons.com/images','2019-010-21T14:50:05Z')

    def test_instance(self):
        self.assertTrue(isinstance(self.new_article,Articles))

    def test_to_check_instance_variables(self):
        self.assertEquals(self.new_article.author,'najma')
